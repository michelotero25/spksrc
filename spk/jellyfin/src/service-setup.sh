...
SERVICE_COMMAND="${SYNOPKG_PKGDEST}/jellyfin --noautorunwebapp --package-name synology -d ${SYNOPKG_PKGVAR}/data -C ${SYNOPKG_PKGTMP}/cache -c ${SYNOPKG_PKGVAR}/config -l ${SYNOPKG_PKGDEST}/var/log -w ${SYNOPKG_PKGDEST}/web"
